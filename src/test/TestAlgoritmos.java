...
public class TestAlgoritmos implements Runnable {
	...
	public static void main(String[] args) {
		...
		String posiciones = "";
		// Hago un for para no repetir codigo y poder ejecutar 5 casos de uso
		for (int i = 0; i < 5; i++) {
			switch (i) {
			...
			// Concateno la cantidad de posiciones del algoritmo, nuevamente correspondiente
			// a la iteracion
			...
			/*
			 * Llamo a la funcion quicksort, donde le envio una copia del array con su
			 * tamaño ,la posicion de inicio y fin.
			 */
			...
			/*
			 * Llamo a una funcion para ejecutar el algoritmo de forma concurrente Le envio
			 * los hilos, la cantidad de hilos, y el tamanio del array Dentro de esta
			 * funcion se calcula el tiempo que tardo
			 */
			Funciones.ejecutarAlgoritmoConcurrente(6, array.length);
			System.out.println("");
		}
	}
}
